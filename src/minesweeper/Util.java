...
public class Util
{
    ...
    {
        IntStream.range(y1, y2).forEach(y -> IntStream.range(x1, x2).forEach(x -> consumer.accept(x, y)));
    }
    ...
    public static void setColor(Region region, Paint paint)
    {
        region.setBackground(new Background(new BackgroundFill(paint, CornerRadii.EMPTY, Insets.EMPTY)));
    }
